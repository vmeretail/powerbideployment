...
SELECT 
	...
	SUM(CASE WHEN taxrate.[Rate] = 0.2 THEN NumberOfCasesDelivered * CaseSize * [OrganisationProductPriceProjectionState].Price ELSE 0 END) [12.5%],
	SUM(CASE WHEN taxrate.[Rate] = 0.125 THEN NumberOfCasesDelivered * CaseSize * [OrganisationProductPriceProjectionState].Price ELSE 0 END) [20%],
