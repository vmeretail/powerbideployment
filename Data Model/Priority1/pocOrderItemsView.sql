...
INNER JOIN (
	...
	INNER JOIN deliveryItemProjectionState deliveryItem ON delivery.deliveryId = deliveryItem.deliveryid AND deliveryItem.SubstitutedOrderItemId = orderItemProjectionState.ExternalOrderItemId
