...
inner join organisationproduct aop on aop.OrganisationProductId = a1.OrganisationProductId
inner join StoreProductStateProjection c1 on c1.StoreProductReportingId = ai.[consequents]
inner join organisationproduct cop on cop.OrganisationProductId = c1.OrganisationProductId
